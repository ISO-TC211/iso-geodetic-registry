...
image:https://img.shields.io/travis/com/ISO-TC211/iso-geodetic-registry.svg?logo=travis&branch=master["Build Status", link="https://travis-ci.com/ISO-TC211/iso-geodetic-registry"]
